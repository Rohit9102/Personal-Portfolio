...
const projects = [
  ...
  },
  {
    ...
    githubUrl:
      "https://github.com/Rohit9102/JS-Mini-Project/tree/main/To_Do_list",
  },
  {
    id: 4,
    ...
    demoUrl: "https://example.com/demo1",
    githubUrl:
      "https://github.com/Rohit9102/JS-Mini-Project/tree/main/QR%20CODE%20Generator",
  },
];
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          crafted with attention to detail and a focus on user experience. I
          hope you enjoy exploring them as much as I enjoyed creating them!
          Check them out!
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            href="https://github.com/Rohit9102"
            target="_blank"
          >
