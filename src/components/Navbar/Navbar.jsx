...
//   { name: "Resume", href: "/projects/Resume.Rohit.pdf" , target:"_blank"},
// ];
...
//          className="md:hidden p-2 text-foreground  mr-12 z-50"
  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <button
          onClick={() => setIsMenuOpen((prev) => !prev)}
          className="md:hidden p-2 mr-12 text-foreground z-50"
          aria-label={isMenuOpen ? "Close menu" : "Open menu"}
        >
          {isMenuOpen ? <X size={24} /> : <Menu size={24} />}{" "}
        </button>
